...
def generate_all_divergence_questions_controller(level_str: str, total_questions: int):
    ...
    output_lines = []
    output_lines.append(f"# Divergent Series & Divergence Test Questions: {level_str} (Total: {total_questions})\n")
...
def run_topic_main():
    ...
    print("Available Levels for Divergent Series & Divergence Test Questions:")
    ...
    return generate_all_divergence_questions_controller(selected_level_str, total_questions)
